object FRM_cad_motorista: TFRM_cad_motorista
  Left = 0
  Top = 0
  ...
  object cxPageControl1: TcxPageControl
    ...
    object cxTabSheet1: TcxTabSheet
      ...
      object gdMotorista: TcxGrid
        ...
        LookAndFeel.NativeStyle = False
        LookAndFeel.SkinName = 'Metropolis'
        object gdMotoristaView: TcxGridDBTableView
          OnDblClick = gdMotoristaViewDblClick
          Navigator.Buttons.CustomButtons = <>
          OnCellDblClick = gdMotoristaViewCellDblClick
          DataController.DataSource = DSMOTORISTA
          ...
          object clEndereco: TcxGridDBColumn
          ...
          object gdMotoristaViewColumn2: TcxGridDBColumn
            Caption = 'Telefone'
          ...
          object clWhats: TcxGridDBColumn
            Caption = 'Celular2'
            DataBinding.FieldName = 'CELULAR2'
            HeaderAlignmentHorz = taCenter
            MinWidth = 100
            Options.Editing = False
            Options.FilteringAddValueItems = False
          ...
          object clCidade: TcxGridDBColumn
            Caption = 'Cidade'
          ...
          object gdMotoristaViewColumn1: TcxGridDBColumn
            DataBinding.FieldName = 'UF'
          end
        end
        object gdMotoristaLv: TcxGridLevel
          GridView = gdMotoristaView
        end
      end
    ...
    object cxTabSheet2: TcxTabSheet
      ...
      object grpEndereco: TGroupBox
        ...
        object CODIGO_MUNICIPIO: TDBEdit
          ...
          ParentFont = False
          TabOrder = 6
          OnKeyPress = CODIGO_MUNICIPIOKeyPress
        end
        object UF: TDBEdit
          Left = 112
          Top = 176
      ...
      object gpDadosPessoais: TGroupBox
        Left = 13
        Top = 9
        Width = 523
        Height = 58
  ...
  object FDMOTORISTA: TFDQuery
    Connection = Module.connection
    SQL.Strings = (
      'select * from cad_motorista where codigo like :pcodigo')
    Left = 328
    Top = 65528
    ParamData = <
      item
    ...
    object FDMOTORISTACODIGO: TFDAutoIncField
      FieldName = 'CODIGO'
      ReadOnly = True
    end
    object FDMOTORISTANOME: TStringField
      FieldName = 'NOME'
      Size = 200
    end
    object FDMOTORISTACPF: TStringField
    ...
    object FDMOTORISTARUA: TStringField
      FieldName = 'RUA'
      Size = 200
    end
    object FDMOTORISTANUMERO: TStringField
      FieldName = 'NUMERO'
      Size = 50
    end
    object FDMOTORISTABAIRRO: TStringField
      FieldName = 'BAIRRO'
      Size = 200
    end
    object FDMOTORISTACOMPLEMENTO: TStringField
      FieldName = 'COMPLEMENTO'
      Size = 50
    end
    object FDMOTORISTACEP: TStringField
      FieldName = 'CEP'
      Size = 50
    end
    object FDMOTORISTAMUNICIPIO: TStringField
      FieldName = 'MUNICIPIO'
      Size = 50
    end
    object FDMOTORISTACODIGO_MUNICIPIO: TStringField
      FieldName = 'CODIGO_MUNICIPIO'
      Size = 50
    end
    object FDMOTORISTAZONA: TStringField
      FieldName = 'ZONA'
      Size = 50
    end
    object FDMOTORISTAREGIAO: TStringField
      FieldName = 'REGIAO'
      Size = 50
    end
    object FDMOTORISTAUF: TStringField
      FieldName = 'UF'
      Size = 50
    end
    object FDMOTORISTACODIGO_UF: TStringField
      FieldName = 'CODIGO_UF'
      Size = 50
    end
    object FDMOTORISTAPAIS: TStringField
      FieldName = 'PAIS'
      Size = 50
    end
    object FDMOTORISTACODIGO_PAIS: TStringField
      FieldName = 'CODIGO_PAIS'
      Size = 50
    end
    object FDMOTORISTATELEFONE: TStringField
      FieldName = 'TELEFONE'
      Size = 50
    end
    object FDMOTORISTACELULAR1: TStringField
      FieldName = 'CELULAR1'
      Size = 50
    end
    object FDMOTORISTACELULAR2: TStringField
      FieldName = 'CELULAR2'
      Size = 50
    end
    object FDMOTORISTAEMAIL1: TStringField
      FieldName = 'EMAIL1'
      Size = 50
    end
    object FDMOTORISTAEMAIL2: TStringField
      FieldName = 'EMAIL2'
      Size = 50
    end
  end
  object SQL_INCREMENT: TFDQuery
    Connection = Module.connection
    SQL.Strings = (
      'select max(codigo)+1 as auto_increment from cad_motorista')
    Left = 207
    Top = 65532
