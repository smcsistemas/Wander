...
uses
  ...
  dxSkinXmas2008Blue, Vcl.ComCtrls, Vcl.StdCtrls, cxButtons, cxRadioGroup;

type
  Tfrm_relato_cliente = class(TForm)
    GroupBox1: TGroupBox;
    GroupBox2: TGroupBox;
    GroupBox3: TGroupBox;
    Label1: TLabel;
...
var
  frm_relato_cliente: Tfrm_relato_cliente;
