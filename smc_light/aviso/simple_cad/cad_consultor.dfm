object frm_cad_consultor: Tfrm_cad_consultor
  ...
  object DS_BANCO_AGENCIA: TDataSource
    DataSet = FD_BANCO_AGENCIA
    Left = 24
    Top = 649
  end
  object FD_BANCO_AGENCIA: TFDQuery
    Connection = Module.connection
    SQL.Strings = (
      'select * from banco_agencia')
    Left = 80
    Top = 649
  end
