...
type
  Tfrm_dados_transporte = class(TForm)
...
var
  frm_dados_transporte: Tfrm_dados_transporte;

implementation

{$R *.dfm}

procedure Tfrm_dados_transporte.FormClose(Sender: TObject;
