...
|        02|             |Criado usuário MASTER e senha PIPOCA                 |
|----------|-------------|-----------------------------------------------------|
|21/02/2020|WANDER       |Passou a tratar usuário e senha de forma             |
|        12|             |criptografada                                        |
|----------|-------------|-----------------------------------------------------|
...
begin
  ...
  if qry = nil then
    raise Exception.Create(Format('Usuário "%s" inexitente', [self.Usuario_nome]))
  else
  begin
...
begin
  if value = '' then
    raise Exception.Create('Login do usuário deve ser informado.');
...
begin
  if value = '' then
    raise Exception.Create('Senha do usuário deve ser informada');
