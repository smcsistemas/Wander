...
begin
  if value = '' then
    raise Exception.Create('Regime Tributário deve ser informado!');
...
begin
  if value = '' then
    raise Exception.Create('Endereço da Empresa deve ser informado!');
...
begin
  if value = '' then
    raise Exception.Create('Inscrição Estadual deve ser informada!');
...
begin
  if value = '' then
    raise Exception.Create('Número da Empresa deve ser informado!');
...
begin
  if value = '' then
    raise Exception.Create('Razão social deve ser infomada!');
