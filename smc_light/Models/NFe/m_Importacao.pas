...
type
  ...
  Type
    ...
    private
      ...
      Im_It_PROD_NFe_O09_CST_IPI: string;
      Im_It_PROD_NFe_O02_clEnq: string;
      ...
      function getIm_It_PROD_NFe_O09_CST_IPI: string;
      function getIm_It_PROD_NFe_O02_clEnq: string;
      ...
      procedure setIm_It_PROD_NFe_O09_CST_IPI(Value: string);
      procedure setIm_It_PROD_NFe_O02_clEnq(Value: string);
    ...
    public
      ...
      PROPERTY PROD_NFe_O09_CST_IPI: string READ getIm_It_PROD_NFe_O09_CST_IPI WRITE setIm_It_PROD_NFe_O09_CST_IPI;
      PROPERTY PROD_NFe_O02_clEnq: string READ getIm_It_PROD_NFe_O02_clEnq WRITE setIm_It_PROD_NFe_O02_clEnq;
    ...
    begin
      ...
      *)
      ...
      try
        ...
        produto.PROD_NFe_N12_CST_ICMS := fieldbyname('cst_icms').asString;
      ...
      produto.PROD_NFe_N11_orig := fieldbyname('origem').asInteger;
...
begin
  ...
  begin
    ...
    begin
      ...
      self.PROD_NFe_O09_CST_IPI := qry.fieldbyname('PROD_NFe_O09_CST_IPI').asString;
      self.PROD_NFe_O02_clEnq := qry.fieldbyname('PROD_NFe_O02_clEnq').asString;
...
function TImportacao.TItem.getIm_It_PROD_NFe_O09_CST_IPI: string;
begin
  result := self.Im_It_PROD_NFe_O09_CST_IPI;
end;
...
function TImportacao.TItem.getIm_It_PROD_NFe_O02_clEnq: string;
begin
  result := self.Im_It_PROD_NFe_O02_clEnq;
end;
...
begin
  Tdb.execquery('INSERT INTO IMPORTACAO_PRODUTOS (ID_NFE, ID_IMPORTACAO,CODIGO, ITEM, DESTINO, DESCRICAO, COD_BARRAS, UM, QTDE, PRECO_UNI, DESCONTO, ACRESCIMOS, VALOR_TOTAL,' +
    ...
    'CST_COFINS, BASE_COFINS, ALIQ_COFINS, TOTAL_COFINS, PROD_NFe_O09_CST_IPI, PROD_NFe_O02_clEnq, BASE_IPI, PROD_NFe_O13_pIPI,' +
    ...
    self.Im_It_Aliq_Cofins, self.Im_It_total_cofins, self.Im_It_PROD_NFe_O09_CST_IPI, self.Im_It_PROD_NFe_O02_clEnq, self.Im_It_base_ipi, self.Im_It_PROD_NFe_O13_pIPI, self.Im_It_total_ipi,
  ...
  case pUk of
    ...
    ukHard:
      Tdb.execquery('UPDATE IMPORTACAO_PRODUTO SET CODIGO=?, ITEM=?, DESTINO=?, DESCRICAO=?, COD_BARRAS=?, UM=?, QTDE=?, PRECO_UNI=?, DESCONTO=?, ACRESCIMOS=?, VALOR_TOTAL=?,' +
        ...
        self.Im_It_Aliq_pis, self.Im_It_total_pis, self.Im_It_cst_cofins, self.Im_It_base_cofins, self.Im_It_Aliq_Cofins, self.Im_It_total_cofins, self.Im_It_PROD_NFe_O09_CST_IPI,
        self.Im_It_PROD_NFe_O02_clEnq, self.Im_It_base_ipi, self.Im_It_PROD_NFe_O13_pIPI, self.Im_It_total_ipi, self.Im_It_ncm, self.Im_It_cest, self.Im_It_cfop, self.Im_It_csosn,
...
procedure TImportacao.TItem.setIm_It_PROD_NFe_O09_CST_IPI(Value: string);
begin
  self.Im_It_PROD_NFe_O09_CST_IPI := Value;
end;
...
procedure TImportacao.TItem.setIm_It_PROD_NFe_O02_clEnq(Value: string);
begin
  self.Im_It_PROD_NFe_O02_clEnq := Value;
end;
