...
{       Module.Query.Close;
   ...
   if fNaoAtualizado('Produto: Indicador de Medicamento...') then
    ...
    begin
       ...
       //Valor ou % ? Deixei %
       Executar('ALTER TABLE PRODUTO_PROD CHANGE DESCONTO_MAXIMO         PROD_MAXDESC      DECIMAL(10,4) NOT NULL DEFAULT 0 COMMENT "% max de desconto"');
       Executar('ALTER TABLE PRODUTO_PROD CHANGE DESCONTO_M_VAREJO       PROD_MAXDESC_VAR  DECIMAL(10,4) NOT NULL DEFAULT 0 COMMENT "% max desconto varejo"');
       Executar('ALTER TABLE PRODUTO_PROD CHANGE DESCONTO_M_ATACADO      PROD_MAXDESC_ATAC DECIMAL(10,4) NOT NULL DEFAULT 0 COMMENT "% max desconto atacado"');
       Executar('ALTER TABLE PRODUTO_PROD CHANGE DESCONTO_M_DISTRIBUIDOR PROD_MAXDESC_DIST DECIMAL(10,4) NOT NULL DEFAULT 0 COMMENT "% max desconto Distribuição"');

       Executar('ALTER TABLE PRODUTO_PROD CHANGE PAGAR_COMISSAO                PROD_COMISSAO      DECIMAL(10,4) NOT DEFAULT 0 COMMENT "% Comissão"');
       Executar('ALTER TABLE PRODUTO_PROD CHANGE COMISSAO_BALCAO               PROD_COMISSAO_LOJA DECIMAL(10,4) NOT DEFAULT 0 COMMENT "% Comissão Loja"');
       Executar('ALTER TABLE PRODUTO_PROD CHANGE BALCAO_COMISSAO_VAREJO        PROD_COMISSAO_VAR  DECIMAL(10,4) NOT DEFAULT 0 COMMENT "% Comissão Varejo"');
       Executar('ALTER TABLE PRODUTO_PROD CHANGE BALCAO_COMISSAO_ATACADO       PROD_COMISSAO_ATAC DECIMAL(10,4) NOT DEFAULT 0 COMMENT "% Comissão Atacado"');
       Executar('ALTER TABLE PRODUTO_PROD CHANGE BALCAO_COMISSAO_DISTRIBUIDOR  PROD_COMISSAO_DIST DECIMAL(10,4) NOT DEFAULT 0 COMMENT "% Comissão Distribuição"');
    ...
    if fNaoAtualizado('PROD_ESTOQMIN') Then
       Executar('ALTER TABLE PRODUTO_PROD CHANGE ESTOQUE_MINIMO PROD_ESTOQMIN    DECIMAL(15,4) NOT NULL DEFAULT 0 COMMENT "Quantidade de Estoque Mínima"');
