...
begin
    ...
    begin
      wnAlerta('Cadastrar Cliente','CNPJ inválido', taLeftJustify, 12);
      edCNPJ.SetFocus;
      exit;
    end;
...
begin
    ...
    begin
      wnAlerta('Cadastrar Cliente','CPF inválido', taLeftJustify, 12);
      edCPF.SetFocus;
      exit;
    end;
...
begin
   ...
   try
     ...
     if vValor < 0 then
     begin
       wnAlerta('Cadastrar Cliente','Valor inválido', taLeftJustify, 12);
...
begin
   ...
   begin
     wnAlerta('Cadastrar Cliente','Ramo de Atividade não encontrado', taLeftJustify, 12);
...
begin
   ...
   begin
      try
         ...
         if vCodigo < 1 then
         begin
           wnAlerta('Cadastrar Cliente','Código inválido', taLeftJustify, 12);
           exit;
         end;
      except
           wnAlerta('Cadastrar Cliente','Código inválido', taLeftJustify, 12);
   ...
   if SL.Count > 0 then
      wnAlerta('Cadastrar Cliente','Informe o campos obrigatórios: '
              + slinebreak
              + slinebreak
              + SL.Text,
              taLeftJustify, 12)
