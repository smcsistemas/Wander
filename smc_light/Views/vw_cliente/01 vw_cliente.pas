...
type
  Tfrm_cliente = class(TForm)
    ...
    DBEdit7: TDBEdit;
    DBEdit16: TDBEdit;
    grid_lista_contatocxGridDBTableView1: TcxGridDBTableView;
    cxGridDBColumn1: TcxGridDBColumn;
    cxGridDBColumn2: TcxGridDBColumn;
    cxGridDBColumn3: TcxGridDBColumn;
    cxGridDBColumn4: TcxGridDBColumn;
    grid_lista_contatocxGridDBTableView1Column2: TcxGridDBColumn;
    cxGridDBColumn5: TcxGridDBColumn;
    grid_lista_contatocxGridDBTableView1Column1: TcxGridDBColumn;
    grid_lista_contatocxGridDBTableView1Column3: TcxGridDBColumn;
    cxGridDBColumn7: TcxGridDBColumn;
    grid_lista_contatocxGridLevel1: TcxGridLevel;
    gpBanco: TGroupBox;
    ...
    grid_lista_contatocxGridDBTableView1Column4: TcxGridDBColumn;
    sql_LISTA_CONTATO: TFDQuery;
    ...
    sql_LISTA_CONTATOCODIGO: TFDAutoIncField;
    sql_LISTA_CONTATOCODIGO_CLIENTE: TIntegerField;
    sql_LISTA_CONTATORESPONSAVEL: TStringField;
    sql_LISTA_CONTATOFUNCAO: TStringField;
    sql_LISTA_CONTATORAMAL: TStringField;
    sql_LISTA_CONTATOTELEFONE: TStringField;
    sql_LISTA_CONTATOCELULAR_1: TStringField;
    sql_LISTA_CONTATOCELULAR_2: TStringField;
    sql_LISTA_CONTATOWHATSAPP: TStringField;
    sql_LISTA_CONTATOEMAIL: TStringField;
    grid_lista_contato: TcxGrid;
...
begin
  ...
  Frm_Municipio.InformarDadosMunicipio(DBEdit81, DBEdit80, DBEdit82, DBEdit3, DBEdit104);
...
//  gpFisica.Visible := true;
//
//   AlterarEnabled([gpData,  gpFisica,  grpEndereco, gpContato, gpBanco,
...
//    u_funcoes.IniciarCadastro([BtnIncluir, BtnCancelar, BtnAlterar], False);
    sql_LISTA_CONTATO.Active := False;
    sql_LISTA_CONTATO.Active := True;
  //  edtBuscar.text := CODIGO.text;
    sql_CLIENTE_CONTATO.Active := True;
    sql_CLIENTE_CONTATO.insert;
...
begin
  sql_LISTA_CONTATO.Cancel;
  sql_LISTA_CONTATO.Close;
end;
...
begin
  ...
  begin
    if dbedt_codigo.Text <> emptystr then
    begin
          condicao := ' where  CLIENTE_CONTATO like "' + dbedt_codigo.Text + '%"';
      end;
    end;
  sql_LISTA_CONTATO.Open(qry_base + condicao);
end;
...
begin
  with SQL_LISTA_CONTATO do
  begin
    Close;
    ParamByName('pcodigo').Value := inttostr(sql_LISTA_CONTATOcodigo.Value);
    Open;
  end;
  CarregarDadosInternos;
end;
