...
begin
  ...
  begin
    ExecQuery('UPDATE PRODUTO SET SALDO =' + TrocaVirgPPto(SQL_ESTOQUE_MOVIMENTACAOQUANTIDADE_ANTERIOR.AsString) + ',PRECO_FINAL_VAREJO =' +
    ...
    try
      ...
      begin
        ...
        begin
          ...
          ExecQuery('update produto set saldo = (saldo + ' + FormatarTag(StrToCurr(Edit14.Text)) + '), preco_final_varejo = ' +
