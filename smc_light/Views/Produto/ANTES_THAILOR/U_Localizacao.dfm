object Frm_Localizacao: TFrm_Localizacao
  ...
  object cxGroupBox10: TcxGroupBox
    Left = 8
    Top = 2
    Caption = 'Localiza'#231#227'o Produto'
    ParentFont = False
    ...
    object cxDBTextEdit2: TcxDBTextEdit
      ...
      DataBinding.DataSource = DS_localizacao
      ParentFont = False
    ...
    object cxDBTextEdit3: TcxDBTextEdit
      ...
      Style.IsFontAssigned = True
      TabOrder = 1
      OnKeyDown = cxDBTextEdit3KeyDown
      Width = 66
    end
    object cxDBTextEdit4: TcxDBTextEdit
      ...
      Style.IsFontAssigned = True
      TabOrder = 2
      OnKeyDown = cxDBTextEdit4KeyDown
      Width = 150
    end
    object cxDBTextEdit5: TcxDBTextEdit
      ...
      Style.IsFontAssigned = True
      TabOrder = 3
      OnKeyDown = cxDBTextEdit5KeyDown
      Width = 120
    end
    ...
    object cxDBTextEdit7: TcxDBTextEdit
      ...
      Style.IsFontAssigned = True
      TabOrder = 5
      OnKeyDown = cxDBTextEdit7KeyDown
      Width = 68
    end
    object cxDBTextEdit8: TcxDBTextEdit
      ...
      Style.IsFontAssigned = True
      TabOrder = 6
      OnKeyDown = cxDBTextEdit8KeyDown
      Width = 48
    end
  ...
  object SQL_Localizacao: TFDQuery
    Connection = Module.connection
    SQL.Strings = (
      'select * from produto_localizacao'
    ...
    object SQL_LocalizacaoCODIGO: TFDAutoIncField
      FieldName = 'CODIGO'
      Origin = 'CODIGO'
      ProviderFlags = [pfInWhere, pfInKey]
      ReadOnly = True
    end
    object SQL_LocalizacaoNOME: TStringField
      FieldName = 'NOME'
      Origin = 'NOME'
      Size = 100
    end
    object SQL_LocalizacaoRUA: TStringField
      FieldName = 'RUA'
      Origin = 'RUA'
      Size = 100
    end
    object SQL_LocalizacaoBAIRRO: TStringField
      FieldName = 'BAIRRO'
      Origin = 'BAIRRO'
      Size = 100
    end
    object SQL_LocalizacaoCIDADE: TStringField
      FieldName = 'CIDADE'
      Origin = 'CIDADE'
      Size = 100
    end
    object SQL_LocalizacaoESTADO: TStringField
      FieldName = 'ESTADO'
      Origin = 'ESTADO'
      Size = 100
    end
    object SQL_LocalizacaoCORREDOR: TStringField
      FieldName = 'CORREDOR'
      Origin = 'CORREDOR'
      Size = 100
    end
    object SQL_LocalizacaoPRATELEIRA: TStringField
      FieldName = 'PRATELEIRA'
      Origin = 'PRATELEIRA'
      Size = 100
    end
    object SQL_LocalizacaoCOLUNA: TStringField
      FieldName = 'COLUNA'
      Origin = 'COLUNA'
      Size = 100
    end
    object SQL_LocalizacaoLADO: TStringField
      FieldName = 'LADO'
      Origin = 'LADO'
      Size = 100
    end
    object SQL_LocalizacaoNUMERO: TStringField
      FieldName = 'NUMERO'
      Origin = 'NUMERO'
      Size = 100
    end
    object SQL_LocalizacaoDATA_CADASTRO: TDateField
      FieldName = 'DATA_CADASTRO'
      Origin = 'DATA_CADASTRO'
    end
  end
  object DS_localizacao: TDataSource
    DataSet = SQL_Localizacao
    Left = 706
    Top = 96
  end
  object SQL_LISTA: TFDQuery
    ...
    object SQL_LISTACIDADE: TStringField
      AutoGenerateValue = arDefault
      FieldName = 'CIDADE'
      Origin = 'CIDADE'
      Size = 100
    end
    object SQL_LISTAESTADO: TStringField
      AutoGenerateValue = arDefault
      FieldName = 'ESTADO'
      Origin = 'ESTADO'
      Size = 100
    end
    object SQL_LISTACORREDOR: TStringField
      AutoGenerateValue = arDefault
      FieldName = 'CORREDOR'
      Origin = 'CORREDOR'
      Size = 100
    end
    object SQL_LISTAPRATELEIRA: TStringField
      AutoGenerateValue = arDefault
      FieldName = 'PRATELEIRA'
      Origin = 'PRATELEIRA'
      Size = 100
    end
    object SQL_LISTACOLUNA: TStringField
      AutoGenerateValue = arDefault
      FieldName = 'COLUNA'
      Origin = 'COLUNA'
      Size = 100
    end
    object SQL_LISTALADO: TStringField
      AutoGenerateValue = arDefault
      FieldName = 'LADO'
      Origin = 'LADO'
      Size = 100
