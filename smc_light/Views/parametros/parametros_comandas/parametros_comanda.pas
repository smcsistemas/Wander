...
type
  Tfrm_paramentros_comandas = class(TForm)
...
var
  frm_paramentros_comandas: Tfrm_paramentros_comandas;

implementation

{$R *.dfm}

procedure Tfrm_paramentros_comandas.btnAlterarClick(Sender: TObject);
var
...
begin
  ...
  u_funcoes.AlterarEnabled([grpComanda], True);
end;

procedure Tfrm_paramentros_comandas.btnCancelarClick(Sender: TObject);
begin
  SQL_PARAMETROS_VENDA.Cancel;
  PadronizarLayout;
end;

procedure Tfrm_paramentros_comandas.btnGravarClick(Sender: TObject);
var
  i: integer;
    _in_pag: string;
  reg: TRegIniFile;
begin
    ...
    on e: exception do
      tdialogs.wnerro('Parâmetros de Comandas', e.message);
  end;
end;

procedure Tfrm_paramentros_comandas.FormClose(Sender: TObject;
...
procedure Tfrm_paramentros_comandas.FormShow(Sender: TObject);
begin
  PadronizarLayout;
end;

procedure Tfrm_paramentros_comandas.PadronizarLayout;
var reg: TRegIniFile;
begin
  ...
  u_funcoes.AlterarEnabled([grpComanda], False);
