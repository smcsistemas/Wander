...
type
  ...
  const
    ...
    PRODUTO_QUERY_BASE =
      'SELECT PROD_CODIGO, PROD_EAN, PROD_DESCRICAO, PROD_CDUNIDADE, SALDO, PROD_REFERENCIASFABRICA, MARCA, PRECO_FINAL_VAREJO FROM PRODUTO_PROD WHERE STATUS_CADASTRAL <> "INATIVO"';
