object Frm_resumo_de_caixas: TFrm_resumo_de_caixas
  Left = 0
  Top = 0
  ...
  object grid_mov_dos_caixas: TcxGrid
    Left = 0
    Top = 64
    Width = 1209
    Height = 505
    ...
    ExplicitWidth = 1218
    object grid_mov_dos_caixasDBBandedTableView1: TcxGridDBBandedTableView
      ...
      Bands = <
        item
          AlternateCaption = 'N'#186' CAIXA'
          Caption = 'N'#186' CAIXA'
          Options.HoldOwnColumnsOnly = True
          Width = 70
        end
        item
          AlternateCaption = 'ABERTO'
          Caption = 'ABERTO'
          Width = 150
        end
        item
        ...
        item
          Caption = 'C. D'#201'BITO'
          Position.BandIndex = 12
          Position.ColIndex = 1
          Width = 70
        end
        item
          Caption = 'C. CR'#201'DITO'
          Position.BandIndex = 12
          Position.ColIndex = 2
          Width = 70
        end
    ...
    object grid_mov_dos_caixasLevel1: TcxGridLevel
      Caption = 'DATA'
      GridView = grid_mov_dos_caixasDBBandedTableView1
    end
  end
  ...
  object cxButton3: TcxButton
    ...
    Width = 124
    Height = 40
    Caption = 'Imprimir'#13'Relat'#243'rio'
