...
procedure Tfrm_main.dxBarLargeButton101Click(Sender: TObject);
begin
  frm_Estoque := Tfrm_Estoque.Create(nil);
  frm_Estoque.ShowModal;
end;

procedure Tfrm_main.dxBarLargeButton102Click(Sender: TObject);
begin
  frm_Localizacao := Tfrm_Localizacao.Create(nil);
  frm_Localizacao.ShowModal;
end;

procedure Tfrm_main.dxBarLargeButton103Click(Sender: TObject);
begin
