...
uses
  ...
  cxImage, cxGraphics, cxControls, cxLookAndFeels, cxLookAndFeelPainters, cxContainer, cxEdit, dxSkinsCore, dxSkinBlack, dxSkinBlue, dxSkinBlueprint, dxSkinCaramel, dxSkinCoffee, dxSkinDarkRoom,
...
type
  TFMR_desenvolvimento = class(TForm)
    cxImage1: TcxImage;
...
var
  FMR_desenvolvimento: TFMR_desenvolvimento;

implementation

{$R *.dfm}

procedure TFMR_desenvolvimento.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  Action := cafree;
  self := nil;
end;

procedure TFMR_desenvolvimento.FormKeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
