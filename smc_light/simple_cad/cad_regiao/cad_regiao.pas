...
|-----|-----|--------------------|---------------------------------------------|
|  117|26/04|Wander              |Implemento o código desta tela               |
|     |20:45|                    |                                             |
================================================================================
}
interface
...
begin
   ...
   //Desabilita o código, que será atribuído sequecial e automaticamente
   edREG_CODIGO.Enabled := False;

   //Posiciona no campo para edição
...
begin
   ...
   begin
     ShowMessage('Informe o nome da Região.');
     edREG_DESCRICAO.SetFocus;
     exit;
   end;
...
begin
   ...
   // Impede o cadastro de duas regiões com o mesmo nome
   if Existe_REG_DESCRICAO(edREG_DESCRICAO.Text) then
   begin
     ShowMessage('Já existe uma Região com este nome.');
     edREG_DESCRICAO.SetFocus;
     exit;
   end;
end;
...
var Q : tFDQuery;
begin
   // Recebe uma descrição e verifica se existe alguma região cadastrada com
   // esta descrição
   ...
   if edREG_CODIGO.Text <> '' then
   begin
      // Com código diferente do atual.. (outro registro)
