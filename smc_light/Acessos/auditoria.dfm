object frm_auditoria: Tfrm_auditoria
  Left = 0
  Top = 0
  ...
  object gdConveniados: TcxGrid
    ...
    object gdConveniadosTbVw: TcxGridDBTableView
      ...
      object gdConveniadosTbVwColumn1: TcxGridDBColumn
        Caption = 'Empresa'
        DataBinding.FieldName = 'LOG_EMPRESA'
      ...
      object gdConveniadosTbVwLOG_USUARIO: TcxGridDBColumn
        Caption = 'Usuario'
        DataBinding.FieldName = 'LOG_USUARIO'
      end
      object gdConveniadosTbVwLOG_ESTACAO: TcxGridDBColumn
        Caption = 'Terminal'
        DataBinding.FieldName = 'LOG_ESTACAO'
        Width = 97
      end
      object gdConveniadosTbVwLOG_DATA: TcxGridDBColumn
        Caption = 'Data'
        DataBinding.FieldName = 'LOG_DATA'
        Width = 82
      end
      object gdConveniadosTbVwLOG_HORA: TcxGridDBColumn
        Caption = 'Hora'
        DataBinding.FieldName = 'LOG_HORA'
      end
      object gdConveniadosTbVwLOG_HISTORICO: TcxGridDBColumn
        Caption = 'Registro'
        DataBinding.FieldName = 'LOG_HISTORICO'
      end
      object gdConveniadosTbVwLOG_vERSAO: TcxGridDBColumn
        Caption = 'Log Vers'#227'o'
        DataBinding.FieldName = 'LOG_vERSAO'
      end
    end
  ...
  object FDQuery1: TFDQuery
    ...
    Left = 704
    Top = 208
    object FDQuery1LOG_DATA: TDateTimeField
      AutoGenerateValue = arDefault
      FieldName = 'LOG_DATA'
      Origin = 'LOG_DATA'
    end
    object FDQuery1LOG_USUARIO: TStringField
      AutoGenerateValue = arDefault
      FieldName = 'LOG_USUARIO'
      Origin = 'LOG_USUARIO'
      Size = 10
    end
    object FDQuery1LOG_HORA: TStringField
      AutoGenerateValue = arDefault
      FieldName = 'LOG_HORA'
      Origin = 'LOG_HORA'
      Size = 5
    end
    object FDQuery1LOG_HISTORICO: TStringField
      AutoGenerateValue = arDefault
      FieldName = 'LOG_HISTORICO'
      Origin = 'LOG_HISTORICO'
      Size = 100
    end
    object FDQuery1LOG_vERSAO: TStringField
      AutoGenerateValue = arDefault
      DisplayLabel = 'Verrs'#227'o'
      FieldName = 'LOG_vERSAO'
      Origin = 'LOG_vERSAO'
      Size = 10
    end
    object FDQuery1LOG_ESTACAO: TStringField
      AutoGenerateValue = arDefault
      FieldName = 'LOG_ESTACAO'
      Origin = 'LOG_ESTACAO'
      Size = 50
    end
    object FDQuery1LOG_EMPRESA: TStringField
      AutoGenerateValue = arDefault
      FieldName = 'LOG_EMPRESA'
      Origin = 'LOG_EMPRESA'
    end
  end
