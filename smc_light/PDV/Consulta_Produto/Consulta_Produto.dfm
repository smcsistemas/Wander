object Frm_Consultar_Preco: TFrm_Consultar_Preco
  ...
  object SQL_ProdutoConsulta: TFDQuery
    ...
    object SQL_ProdutoConsulta_PROD_NFe_N14_pRedBC: TStringField
      AutoGenerateValue = arDefault
      FieldName = '%_PROD_NFe_N14_pRedBC'
      Origin = '`%_PROD_NFe_N14_pRedBC`'
    end
    ...
    object SQL_ProdutoConsulta_PROD_NFe_N14_pRedBC_ST: TStringField
      AutoGenerateValue = arDefault
      FieldName = '%_PROD_NFe_N14_pRedBC_ST'
      Origin = '`%_PROD_NFe_N14_pRedBC_ST`'
    end
    ...
    object SQL_ProdutoConsultaPROD_COMISSAO_EXT_VAR2: TBCDField
      AutoGenerateValue = arDefault
      FieldName = 'PROD_COMISSAO_EXT_VAR'
      Origin = 'PROD_COMISSAO_EXT_VAR'
      Precision = 10
    end
    object SQL_ProdutoConsultaPROD_COMISSAO_EXT_ATAC2: TBCDField
      AutoGenerateValue = arDefault
      FieldName = 'PROD_COMISSAO_EXT_ATAC'
      Origin = 'PROD_COMISSAO_EXT_ATAC'
      Precision = 10
    end
    object SQL_ProdutoConsultaPROD_COMISSAO_EXT_DIST2: TBCDField
      AutoGenerateValue = arDefault
      FieldName = 'PROD_COMISSAO_EXT_DIST'
      Origin = 'PROD_COMISSAO_EXT_DIST'
      Precision = 10
