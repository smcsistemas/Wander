object frm_movimento_pdv: Tfrm_movimento_pdv
  ...
  object cxGrid2: TcxGrid
    ...
    object cxGridDBTableView1: TcxGridDBTableView
      ...
      object cxGridDBTableView1LANCAMENTO: TcxGridDBColumn
        Caption = 'Data | Hora'
      ...
      object cxGridDBTableView1PDV: TcxGridDBColumn
        DataBinding.FieldName = 'PDV'
        HeaderAlignmentHorz = taCenter
        Options.Editing = False
        Width = 43
      end
      ...
      object cxGridDBTableView1Total: TcxGridDBColumn
        ...
        HeaderAlignmentHorz = taCenter
        Options.Editing = False
        Styles.OnGetContentStyle = cxGridDBTableView1TotalStylesGetContentStyle
        Width = 100
      end
  ...
  object qCaixa: TFDQuery
    ...
    SQL.Strings = (
      'SELECT '
        ...
        #9'CD.LANCAMENTO, c.PDV, o.usuario as nome, cd.descricaooperacao A' +
        'S Operacao, '
      
        #9'COALESCE(vp.TOTAL_PAGO, cd.Total) AS total, cd.descricao, COALE' +
        'SCE(vp.TIPO_PAGAMENTO,'#39'Dinheiro'#39' ) AS Tipo,'
      #9'cd.operacao AS CodigoOperacao'
      'FROM CAIXADETALHE CD'
      'INNER JOIN CAIXA C ON C.Id = cd.IdCaixa'
      'INNER JOIN usuario o ON o.codigo = cd.codigousuario'
      'LEFT JOIN Venda v ON v.codigo_venda = cd.codigovenda'
      'LEFT JOIN venda_pagamento vp ON vp.CODIGO_VENDA = v.codigo_venda')
    Left = 231
    Top = 216
    object qCaixaLANCAMENTO: TDateTimeField
    ...
    object qCaixaOperacao: TStringField
      AutoGenerateValue = arDefault
      FieldName = 'Operacao'
    ...
    object qCaixaCodigoOperacao: TStringField
      AutoGenerateValue = arDefault
