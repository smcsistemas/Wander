...
|     |   02:48|cadastro_sub_grupo  |grupo e família associados e que no banco |
...
|-----|--------|--------------------|------------------------------------------|
|  169|23/05/20|wander              |Passa a retornar o código subgrupo se foi |
...
var
  ...
  m_subgrupo: TDBEdit;
  Frm_SubGrupo_CODIGO:String; // Retorna o código do Subgrupo qdo consulta
implementation
...
begin
  //23/05/2020
  //Retorna o código do subgrupo selecionado
