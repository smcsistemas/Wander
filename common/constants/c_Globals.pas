...
const
  // [th] Constantes para Tipo de Históricos
  thEstoque    = (1);
  thFinanceiro = (2);
...
type
  TConsultaGenericaKind = (cgNull, cgProduto, cgFornecedor, cgUsuario, cgCliente, cgMunicipio, cgNCM, cgVendedor, cgGerente, cgFormasPagamento, cgCFOP, cgCSOSN, cgANP, cgSocio,
    cgMarca, cgICMS, cgPIS, cgCOFINS, cgORIGEM, cgOperadorCaixa);
...
type
...

  {
    ...
    dbLocal = Conexão local (localhost, 127.0.0.1 etc)
    dbOnline = Conexão remota
...
type
  ...
  {
    Define qual tipo de update será utilizado na função 'Salvar' nas models
...
type
  ...
  {
    Tipo de ordenação utilizado em consultas
